...
def Verlet(a,initialConditions,dt):
  ...
  # The Velocity Verlet has been implemented here with the implementation following
  # The algorithm as mentioned on https://www.wikiwand.com/en/Verlet_integration#/Velocity_Verlet
  # Another source which may be referenced to is http://www.fisica.uniud.it/~ercolessi/md/md/node21.html
