...
def dcd(positions_n_plus_half ,velocites_n_plus_half, x_center_grid, y_center_grid,shape_function, no_of_particles, dx, dy):
    ...
    Jx_x_indice, Jx_y_indices, Jx_values_at_these_indices = shape_function(positions_n_plus_half[:no_of_particles], velocites_n_plus_half[:no_of_particles], x_right_grid, y_center_grid, dx, dy)
    for i in range(len(Jx_x_indice)):
        Jx[Jx_x_indice, Jx_y_indices] = Jx_values_at_these_indices


    Jy_x_indice, Jy_y_indices, Jy_values_at_these_indices = shape_function(positions_n_plus_half[no_of_particles:2*no_of_particles], velocites_n_plus_half[no_of_particles:2*no_of_particles], x_center_grid, y_top_grid, dx, dy)
    for i in range(len(Jy_x_indice)):
        Jy[Jy_x_indice, Jy_y_indices] = Jy_values_at_these_indices

    Jz_x_indice, Jz_y_indices, Jz_values_at_these_indices = shape_function(positions_n_plus_half[2*no_of_particles:3*no_of_particles], velocites_n_plus_half[2*no_of_particles:3*no_of_particles], x_center_grid, y_center_grid, dx, dy)
    for i in range(len(Jz_x_indice)):
        Jy[Jz_x_indice, Jz_y_indices] = Jz_values_at_these_indices
