...
def error(a,b):
    ...
    h5f.create_dataset('time/solution_dataset'+str(a), data=time)
    h5f.close()


    h5f = h5py.File('posa/solution'+str(a)+'.h5', 'w')
    h5f.create_dataset('posa/solution_dataset'+str(a), data=position_analytical)
    h5f.close()

    h5f = h5py.File('posn/solution'+str(a)+'.h5', 'w')
    h5f.create_dataset('posn/solution_dataset'+str(a), data=position_numerical)
    h5f.close()

    h5f = h5py.File('vela/solution'+str(a)+'.h5', 'w')
    h5f.create_dataset('vela/solution_dataset'+str(a), data=velocity_analytical)
    h5f.close()

    h5f = h5py.File('veln/solution'+str(a)+'.h5', 'w')
    h5f.create_dataset('veln/solution_dataset'+str(a), data=velocity_numerical)
    h5f.close()
    return 1
