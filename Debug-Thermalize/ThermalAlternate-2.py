...
for time_index,t0 in enumerate(time):
    ...
    collidingright=np.ones(no_of_particles)
    collidingleft=np.ones(no_of_particles)
    ...
    for i in range(0,cr,2):
        ...
        sol[collidingright[i]+3*no_of_particles]=abs(y_1)*(-1)
        sol[collidingright[i]+4*no_of_particles]=abs(y_2)*np.random.choice([1,-1])
        sol[collidingright[i]+5*no_of_particles]=abs(y_3)*np.random.choice([1,-1])
        sol[collidingright[i+1]+3*no_of_particles]=abs(y_4)*(-1)
        sol[collidingright[i+1]+4*no_of_particles]=abs(y_5)*np.random.choice([1,-1])
        sol[collidingright[i+1]+5*no_of_particles]=abs(y_6)*np.random.choice([1,-1])
    ...
    for i in range(0,cl,2):
        ...
        y_5=const2*np.sqrt(-2*np.log(x_5))*np.cos(2*np.pi*x_6)
        y_6=const2*np.sqrt(-2*np.log(x_5))*np.sin(2*np.pi*x_6)
        sol[collidingleft[i]+3*no_of_particles]=abs(y_1)
        sol[collidingleft[i]+4*no_of_particles]=abs(y_2)*np.random.choice([1,-1])
        sol[collidingleft[i]+5*no_of_particles]=abs(y_3)*np.random.choice([1,-1])
        sol[collidingleft[i+1]+3*no_of_particles]=abs(y_4)
        sol[collidingleft[i+1]+4*no_of_particles]=abs(y_5)*np.random.choice([1,-1])
        sol[collidingleft[i+1]+5*no_of_particles]=abs(y_6)*np.random.choice([1,-1])
